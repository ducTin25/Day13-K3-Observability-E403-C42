...
- Evidence dashboard: [`../config/dashboard.yaml`](../config/dashboard.yaml) định nghĩa latency, traffic, error, cost, token và quality; ảnh dashboard runtime chưa được thu thập.
